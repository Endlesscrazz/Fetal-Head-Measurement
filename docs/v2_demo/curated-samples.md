...
| `025_HC` | typical | 0.9438 | 3.59 | Useful geometry teaching case: raw contour is noisy, cleaned contour improves, ellipse result differs. |
...
- **typical**: samples near ordinary model behavior, including the
  cleanup/ellipse teaching case. For `025_HC`, raw contour HC error is
  13.40 mm, cleaned contour HC error is 1.43 mm, and cleaned ellipse HC error is
  3.59 mm.
