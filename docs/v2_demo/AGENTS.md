...
This file is the source of truth for agents working on the v2 demo.
The root `AGENTS.md` still controls the overall repository. This file narrows
the rules for portfolio/demo work.
