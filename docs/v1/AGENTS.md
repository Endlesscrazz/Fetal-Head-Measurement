...
This file is the archived v1 operating contract. It applies to bug fixes or
reproducibility updates for the completed course pipeline. Current v2 demo work
is governed by the root `AGENTS.md`.
...
Every v1 maintenance session must read these files before making changes:

1. `docs/v1/AGENTS.md`
2. `project-tasks.md`
3. `handoff.md`
4. `docs/v1/DECISIONS.md`
...
Update `docs/v1/DECISIONS.md` whenever a non-trivial v1 decision is made about:
