...
Note:
This v1 decision log was moved from repository root to `docs/v1/` on
2026-04-28. Older entries that refer to root governance files describe the
historical v1 layout at the time they were written.
